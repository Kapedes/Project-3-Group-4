...
function optionChanged(selectedTitle) {
     // Get the title from the filtered data array
     var title = selectedTitle[0].Title;
...
function displayDatasetInfo(data) {
    ...
    // You can log dataset info or display it in the UI as needed
    console.log("Dataset Information:");
    console.log(data); // Example: Log dataset info to the console
}
...
function createRadarChart(data) {
    ...
    age45AboveVotes = age45AboveVotes || 0;
    ...
    movieBox.id = 'movieBox'; // Add an ID to easily select the movie box
